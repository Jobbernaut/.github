...
If a repository lacks a specific LICENSE file, the license located at [Jobbernaut/LICENSE.md](https://github.com/Jobbernaut/.github/blob/main/LICENSE.md) applies by default.
